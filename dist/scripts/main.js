...
;// CONCATENATED MODULE: ./app/scripts/modules/sliders.js
...
;// CONCATENATED MODULE: ./app/scripts/modules/spollers.js
...
*/
;// CONCATENATED MODULE: ./app/scripts/modules/dynamic_adapt.js
// Dynamic Adapt v.1
...
;// CONCATENATED MODULE: ./app/scripts/modules/choices.js
...
[...selectChoices].forEach((select) => {
	let choices = new scripts_choices(select, choiceConfig)
})
;// CONCATENATED MODULE: ./app/scripts/modules/tabs.js
/*================== TABS ====================*/
...
;// CONCATENATED MODULE: ./app/scripts/modules/accordeon.js
...
const main_tabContent = document.querySelectorAll('.tabs__content');
